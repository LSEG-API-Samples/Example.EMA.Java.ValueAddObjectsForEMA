...
public interface FlatChain extends Chain
{
     ...
     * {@link FlatChain} is created. See the {@link Builder#onElementAdded(com.refinitiv.platformservices.rt.objects.chain.FlatChain.OnElementAddedFunction)} 
     * for more details.
     */
    @FunctionalInterface
     ...
     * created. See the {@link Builder#onElementChanged(com.refinitiv.platformservices.rt.objects.chain.FlatChain.OnElementChangedFunction) }
     * for more details.
     */
    @FunctionalInterface
     ...
     * {@link FlatChain} is created. See the {@link Builder#onElementRemoved(com.refinitiv.platformservices.rt.objects.chain.FlatChain.OnElementRemovedFunction) } 
     * for more details.
     */
    @FunctionalInterface
     ...
     * See the {@link Builder#onComplete(com.refinitiv.platformservices.rt.objects.chain.FlatChain.OnCompleteFunction) }
     * for more details.
     */
    @FunctionalInterface
     ...
     * This operation is optionally set when the {@link FlatChain} is created. 
     * See the {@link Builder#onError(com.refinitiv.platformservices.rt.objects.chain.FlatChain.OnErrorFunction) }
     * for more details.
     */
    @FunctionalInterface
    ...
    public static class Builder
    {
         ...
         * skip for several display templates. Checkout this <a href="https://developers.refinitiv.com/platform-services-work-progress/ema/docs?content=12021&type=documentation_item" target="_blank">Refinitiv article</a> 
